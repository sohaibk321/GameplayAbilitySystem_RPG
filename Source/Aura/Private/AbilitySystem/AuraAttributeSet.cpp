...
void UAuraAttributeSet::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	// Always replicate; repnotify always means if value is set on server, then update the client
	// repnotify_onchanged means if you set the value on the server, and it's not hanged, then it won't be replicated
...
// This function is for clamping purposes
