...
// Use F in FAttributeFuncPtr because the template is mapping the FGameplayAttribute
// typedef is specific to fgameplayattribute
...
public:
	...
	// Maps gameplay tags to their function pointers
